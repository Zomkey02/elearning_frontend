      ...
      <div className="bg-[#fdfdfd] text-black">
            ...
            {isLoggedIn ? ( <LogOut isVisible={true} /> ) : (
              <>
               <ListItem NavLink="/login">Login</ListItem>
                <Link to="/signup" className="bg-[#6DAE81] text-white px-4 py-2 rounded hover:bg-white:text-black transition">Sign up</Link>
              </>
            )}            
          </div>
        ...
        {open && (
          <div className="lg:hidden px-4 pb-4 space-y-2 bg-[#fdfdfd]">
            ...
            <Link to="/signup" className="block bg-[#6DAE81] text-white px-4 py-2 rounded hover:bg-white:text-black transition">Sign up</Link>
...
const ListItem = ({ children, NavLink }: ListItemProps) => {
  return (
     <Link
      to={NavLink}
      className="text-black hover:text-[#6DAE81]"
    >
      {children}
    </Link>
  );
